angular.module('qstCtrl', []).controller('questionController', function($scope, $compile,serviceDB) {
    ...
    $scope.addMoreOptions = function() {
        ...
        console.log('add More Opp');
         html = "<div class='form-inline Op'><input type='checkbox' name='checkbx' value='ques.ans[0].opt'><input type='text'class='form-control' ng-model='ques.ans[$index+" + Count + "].opt' placeholder='Enter Options'></div> </div>"
